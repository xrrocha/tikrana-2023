...
import plenix.tikrana.http.ContentType
import plenix.tikrana.http.ContentTypes.ContentTypeHeader
import plenix.tikrana.http.ContentTypes.TextPlain
import plenix.tikrana.http.HttpCodec
import plenix.tikrana.http.MethodName
import plenix.tikrana.http.Path
                        ...
                        .flatMap { handler ->
                            val requestObject =
                                if (MethodsWithBody.contains(exchange.requestMethod).not()) {
                                    ...
                                    val contentTypes = exchange.requestHeaders[ContentTypeHeader] ?: listOf(TextPlain)
                                    httpCodec.decode(exchange.requestBody, contentTypes)
                                }
                            requestObject
